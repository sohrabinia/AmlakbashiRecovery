    ...
    myajax("reserve/checkreserve", "advertise_id=" + advertise_id +
        ...
        "&number_of_guests=" + guestCount, function (ret) {
            if (ret.val == 1) {
                ...
                //                    $.confirm({
                //                        title: 'ورود به سایت',
                //                        content: 'برای ثبت درخواست رزرو ابتدا باید وارد سایت شوید',
                //                        type: 'blue',
                //                        typeAnimated: true,
                //                        buttons: {
                //                            ورود: function () {
                ...
                //                        //$("#to_date_label").hide();
                //                        //$("#reserve_price_label").hide();
                //                        window.location.href = '/Reserve/reservemanager?msg=' + 'reserve_request';
                //                    }
                //                    else if (ret.val == 0) {
                //                        showErrorMessage('خطا', ret.msg);
                //                    }
