-- =================================================================================
-- AMLAKBASHI V9.0 - AI OPERATIONAL INTELLIGENCE PLATFORM T-SQL MIGRATION SCRIPT
-- Target Database: amlakbas_db (Microsoft SQL Server 2016 / 2019 / 2022)
-- Execution: Execute inside SSMS or sqlcmd against the restored database
-- =================================================================================
...
-- 7. Seed Mandatory AIAgents Directory
...
PRINT 'AmlakBashi V9.0 Database Migration executed successfully. Existing schemas are fully preserved.';
GO
