    ...
    public class FileControllerRoutes
    {
        public static void Config(IEndpointRouteBuilder endpointRouteBuilder)
        {
            endpointRouteBuilder.MapControllerRoute(
                ...
                constraints: new { slug = new PostImageConstraint()/*, subdomain = new SubdomainRouteConstraint("www")*/ }
            );
            endpointRouteBuilder.MapControllerRoute(
            ...
            endpointRouteBuilder.MapControllerRoute(
                ...
                constraints: new { slug = new ImageDimensionConstraint()/*, subdomain = new SubdomainRouteConstraint("www")*/ }
            );
        }
    }
}
