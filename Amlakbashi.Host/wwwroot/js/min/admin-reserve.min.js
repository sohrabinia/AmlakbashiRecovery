function copyStringToClipboard(n,t){var i=document.createElement("textarea");i.value=n;i.setAttribute("readonly","");i.style={position:"absolute",left:"-9999px"};document.body.appendChild(i);i.select();document.execCommand("copy");document.body.removeChild(i);alertify.success(t+" کپی شد")}function callForRequest(n){showConfirm("آیا با میزبان، تماس پاسخ درخواست رزرو گرفته شود؟",function(){sendGetAjax("/Reserve/CallForRequest","reserve_id="+n,function(t){t.status==1?(addInfo(n,"توسط سیستم با میزبان تماس گرفته شد",!0),successAlert("تماس با میزبان انجام شد")):t.stat==2?errorAlert("میزبان هم اکنون به درخواست رزرو پاسخ داده است"):errorAlert("متاسفانه عملیات با خطای فنی مواجه شد")})})}function doSupport(n,t){showConfirm("آیا قصد دارید این رزرو را پشتیبانی کنید؟",function(){sendGetAjax("/Reserve/DoSupport","reserve_id="+n,function(i){i.status==1?($(t).remove(),reserveAdminHubConnection.invoke("reserveSupporterAdded",n,i.supporterName,i.supporterPhoto),successAlert("عملیات با موفقیت انجام شد")):i.status==2?(changeSupporterElem=t,showPopup("<div>هشدار: "+i.msg+'<\/div><div>لطفا دلیل انتقال پشتیبانی را بنویسید: <input type="text" onchange="changeSupporterReason = $(this).val();" /><\/div><p>انتقال پشتیبانی انجام شود؟<\/p><div style="text-align:center;"><button onclick="moveSupport('+n+')">انتقال پشتیبانی<\/button>')):errorAlert(i.msg)})})}function moveSupport(n){if(!changeSupporterReason){errorAlert("لطفا دلیل انتقال پشتیبانی را وارد کنید");return}sendGetAjax("/Reserve/DoSupport","reserve_id="+n+"&force=true&transfer_reason="+changeSupporterReason,function(t){hidePopup();t.status===1?($(changeSupporterElem).remove(),reserveAdminHubConnection.invoke("reserveSupporterAdded",n,t.supporterName,t.supporterPhoto),successAlert("عملیات با موفقیت انجام شد")):errorAlert(t.msg)})}function callForPayment(n){showConfirm("آیا با مهمان تماس پرداخت رزرو گرفته شود؟",function(){sendGetAjax("/Reserve/CallForPayment","reserve_id="+n,function(t){t.status==1?(addInfo(n,"توسط سیستم با مهمان تماس گرفته شد",!0),successAlert("تماس با مهمان انجام شد")):t.stat==2?errorAlert("مهمان هم اکنون اقدام به پرداخت کرده است"):errorAlert("متاسفانه عملیات با خطای فنی مواجه شد")})})}function cancelBySystem(n){showConfirm("آیا درخواست رزرو توسط سیستم لغو شود؟",function(){sendGetAjax("/Reserve/CancelBySystem","reserve_id="+n,function(t){t.status==1?(reserveAdminHubConnection.invoke("cancelReserve",n),successAlert("درخواست رزرو لغو شد")):t.stat==2?errorAlert("این رزرو توسط مهمان/میزبان پاسخ داده شده است و امکان لغو سیستمی آن وجود ندارد"):errorAlert("عملیات با خطای فنی مواجه شد")})})}function showSiteClearingHostPopup(n){loadPopup("/Reserve/GetSiteClearingHostInfo?reserveId="+n)}function showSiteRefundGuestPopup(n){loadPopup("/Reserve/GetSiteRefundGuestInfo?reserveId="+n)}function siteClearingHostWithCredit(n){showConfirm("آیا سهم میزبان از طریق کیف پول تسویه شود؟",function(){sendGetAjax("/Reserve/SiteClearingWithCredit","reserve_id="+n,function(t){t.status==1?(showConfirm(t.msg+". آیا پیامک ارسال شود؟",function(){sendGetAjax("/Reserve/SendSiteClearingWithCreditSms","reserve_id="+n+"&payable_price="+t.payable_price+"&transaction_id="+t.transaction_id,function(){})}),reserveAdminHubConnection.invoke("reserveCleared",n)):t.status==0&&errorAlert("عملیات با خطای فنی مواجه شد")})})}function siteRefundGuestWithCredit(n){showConfirm("آیا مبلغ رزرو از طریق کیف پول به مهمان عودت داده شود؟",function(){sendGetAjax("/Reserve/SiteRefundGuestWithCredit","reserve_id="+n,function(t){t.status==1?(successAlert(t.msg),reserveAdminHubConnection.invoke("reserveRefunded",n)):t.status==0&&errorAlert(t.msg)})})}function payReserveWithCreditHost(n){showConfirm("آیا درصد املاک باشی از کیف پول میزبان کسر شود؟",function(){sendGetAjax("/Reserve/PayReserveWithCreditHost","reserve_id="+n+"&pay_reserve_type=1",function(t){t.status==1?(successAlert(t.msg),reserveAdminHubConnection.invoke("changeStatus",n,t.new_reserve_status),reserveAdminHubConnection.invoke("payReserveWithCreditHost",n)):t.status==0&&errorAlert(t.msg)})})}function addInfo‌ByElem(n,t){var i=$(t).val();if(i==null||i==""){errorAlert("لطفا متن توضیح را وارد کنید");return}addInfo(n,i)}function addInfo(n,t,i){i===!0?executeAddInfo(n,t,!0):showConfirm('متن توضیحات: "'+t+'" اضافه شود؟',function(){executeAddInfo(n,t,!1);hidePopup()})}function toggleShouldFollow(n,t){sendGetAjax("/reserve/getshouldfollowstate","reserve_id="+n,function(i){i.status==0?errorAlert(i.msg):i.status==1&&(i.shouldFollow?showConfirm("از در حال پیگیری حذف شود؟",function(){sendGetAjax("/reserve/toggleshouldfollow","reserve_id="+n,function(t){t.status==0?errorAlert(t.msg):t.status==1&&reserveAdminHubConnection.invoke("toggleShouldFollow",n,t.new_status)})}):(addToShouldFollow(n),sholdFollowElement=t))})}function addToShouldFollowByElem(n,t){var i=$(t).val();addToShouldFollow(n,i)}function addToShouldFollow(n,t){t!=undefined?showConfirm('متن توضیحات: "'+t+'" اضافه شود؟',function(){executeAddToShouldFollow(n,t)}):showPopup("افزودن به رزرو های در حال پیگیری. کد رزرو: "+n+'<br/><input id="followReasonInput" type="text" /><br /><button onclick="addToShouldFollowByElem('+n+',this.previousSibling.previousSibling)" style="padding: 5px;margin:5px; width:100px; height: 30px;"><i class="fa fa-plus"><\/i> افزودن<\/button>')}function executeAddToShouldFollow(n,t){sendGetAjax("/reserve/toggleshouldfollow","reserve_id="+n+"&text="+t,function(i){i.status==0?errorAlert(i.msg):i.status==1&&(hidePopup(),reserveAdminHubConnection.invoke("toggleShouldFollow",n,i.new_status),reserveAdminHubConnection.invoke("addSupporterInfoToReserve",n,t),successAlert("عملیات انجام شد"))})}function executeAddInfo(n,t,i){sendGetAjax("/reserve/addsupporterinfotoreserve","reserve_id="+n+"&text="+t,function(r){r.status==0?errorAlert("عملیات با خطا مواجه شد"):r.status==1&&(i===!0?reserveAdminHubConnection.invoke("addSupporterInfoToReserve",n,t):(successAlert("اطلاعات مورد نظر با موفقیت ثبت شد"),reserveAdminHubConnection.invoke("addSupporterInfoToReserve",n,t)))})}function showComment(n){var t=decodeURI(n);showPopup(t)}function showCancelDiscussion(n){loadPopup("/canceldiscussion/getreservecanceldiscussion?reserve_id="+n)}function nextCallState(n,t,i,r){var u=$(r).attr("js-call-state");if(u>1){errorAlert("تماس با "+i+" قبلا انجام شده");return}let f=u==0?"آیا تماس با "+i+" ثبت شود؟":"آیا "+i+" پاسخ داد؟";showConfirm(f,function(){sendGetAjax("/reserve/nextcallstate","reserve_id="+n+"&hostOrGuest="+t,function(r){r.status==1&&(r.new_state.toString()=="1"?executeAddInfo(n,"توسط پشتیبان با "+i+" تماس گرفته شد",!1):r.new_state.toString()=="2"&&executeAddInfo(n,"نتیجه تماس با "+i+": پاسخ داد",!1),reserveAdminHubConnection.invoke("changeCallState",n,t,r.new_state,r.new_state_color),hidePopup())})})}function showCallPopup(n,t,i){sendGetAjax("/user/getallphonenumbers","user_id="+n,function(n){if(n.status==1){var r="<div>کد رزرو: "+t+"<\/div>";r+="<div "+(n.full_name=="ثبت نشده"?'style="color:red;"':"")+">نام "+i+" : "+n.full_name+"<\/div>";r+='<div style="display:flex;justify-content:center;">';r+='<div style="display:flex;flex-flow:column;align-items:flex-end;font:25px Liransans;">';n.main_mobile!=null&&(r+='<div style="display:flex;flex-flow:row;"><div>موبایل اصلی: <\/div><div style="direction:ltr;margin:5px;color:#2200ff;">'+n.main_mobile.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3")+"<\/div><\/div>");n.mobile_1!=null&&n.main_mobile!=n.mobile_1&&(r+='<div style="display:flex;flex-flow:row;"><div>موبایل ۱: <\/div><div style="direction:ltr;margin:5px;color:#2200ff;">'+n.mobile_1.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3")+"<\/div><\/div>");n.mobile_2!=null&&(r+='<div style="display:flex;flex-flow:row;"><div>موبایل ۲: <\/div><div style="direction:ltr;margin:5px;color:#2200ff;">'+n.mobile_2.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3")+"<\/div><\/div>");n.land_line!=null&&(r+='<div style="display:flex;flex-flow:row;"><div>تلفن ثابت:‌ <\/div><div style="direction:ltr;margin:5px;color:#2200ff;">'+n.land_line.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3")+"<\/div><\/div>");n.third_person!=null&&(r+='<div style="display:flex;flex-flow:row;"><div>شخص ثالث:‌ <\/div><div style="direction:ltr;margin:5px;color:#2200ff;">'+n.third_person.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3")+"<\/div><\/div>");r+="<\/div><\/div>";showPopup(r)}else errorAlert(n.msg)})}function showInfoPopup(n,t){showPopup(t)}function addGuestPayment(n){loadPopup("/reserve/addguestpaymentpopup?id="+n)}function editRating(n){ratingDialog(n,function(){})}function toggleDisableAutoCancel(n,t){var i=$(t).attr("data-value");i=i==="true";i=!i;showConfirm("آیا می خواهید "+(i?"لغو خوکار سیستم برای این رزرو غیرفعال شود؟":"دوباره لغو خودکار سیستم را برای این رزرو فعال کنید؟"),function(){sendGetAjax("/reserve/toggledisableautocancel","id="+n+"&active="+i,function(n){n.status==1?($(t).attr("data-value",i),$(t).css("color",i?"limegreen":""),successAlert(i?"لغو خودکار سیستم برای این رزرو غیرفعال شد. این رزرو فقط به صورت دستی قابل لغو خواهد بود":"لغو خودکار سیستم برای این رزرو دوباره فعال شد")):errorAlert(n.msg)})})}function toggleAccVisited(n,t){var i=$(t).attr("data-value");i=i==="true";i=!i;showConfirm(i?"آیا این اقامتگاه توسط مهمان بازدید شده است؟":"آیا بازدید اقامتگاه حذف شود؟",function(){sendGetAjax("/reserve/toggleaccvisited","id="+n+"&active="+i,function(n){n.status==1?($(t).attr("data-value",i),$(t).css("color",i?"limegreen":""),successAlert(i?"بازدید اقامتگاه برای این رزرو ثبت شد":"بازدید اقامتگاه از این رزرو حذف شد")):errorAlert(n.msg)})})}function showMoreOptionBox(n,t){loadCollapse(n,$(n).next()[0],"/reserve/GetReserveAdminDetails?reserveId="+t)}function showReserveEditForm(n){loadPopup("/reserve/popupedit?reserveId="+n)}function SubmitReserveEditForm(){submitPopup("/reserve/popupedit")}function showSupportInfo(n){loadPopup("/reserve/getsupportinfo?reserveId="+n)}function toggleMyReserves(n){var t=$("#show_my_reserves_input");t.val(n);$("#more_filter_form").submit()}function toggleShouldFollowReserves(n){var t=$("#should_follow_input");t.val(n);$("#more_filter_form").submit()}function toggleDisableAutoCancelFilter(n){var t=$("#disableAutoCancelFilter");t.val(n);$("#more_filter_form").submit()}function toggleAccVisitFilter(n){var t=$("#accVisitedFilter");t.val(n);$("#more_filter_form").submit()}function toggleStatus(n){$("select#reserve-status-input").val()==n.toString()&&(n=-1);var t=$('select#reserve-status-input option[value="'+n+'"]');t.attr("selected","selected");$("#more_filter_form").submit()}function toggleMainFilter(n){var t=$("#main_filter_input");t.val(n);$("#filter_form").submit()}function toggleInstantResFilter(n){var t=$("#instantReserveFilter");t.val(n);$("#filter_form").submit()}function toggleTodayFinishStay(n){var i=$("#reserve_end_date_picker"),t;n==i.val()&&$("select#general_status_input").val()=="0"?(i.val(""),t=$('select#general_status_input option[value="-1"]'),t.attr("selected","selected")):(i.val(n),t=$('select#general_status_input option[value="0"]'),t.attr("selected","selected"));$("#more_filter_form").submit()}function toggleSiteTodayClearing(n){var t=$("#clearing_date_picker"),i;new_status=1;new_date=n;$("select#cleared_status_input").val()=="1"&&t.val()==n&&(new_status=-1,new_date="");i=$('select#cleared_status_input option[value="'+new_status+'"]');i.attr("selected","selected");t.val(new_date);$("#more_filter_form").submit()}(function(n,t){typeof exports=="object"&&typeof module=="object"?module.exports=t():typeof define=="function"&&define.amd?define([],t):typeof exports=="object"?exports.signalR=t():n.signalR=t()})(window,function(){return function(n){function t(r){if(i[r])return i[r].exports;var u=i[r]={i:r,l:!1,exports:{}};return n[r].call(u.exports,u,u.exports,t),u.l=!0,u.exports}var i={};return t.m=n,t.c=i,t.d=function(n,i,r){t.o(n,i)||Object.defineProperty(n,i,{enumerable:!0,get:r})},t.r=function(n){typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(n,Symbol.toStringTag,{value:"Module"});Object.defineProperty(n,"__esModule",{value:!0})},t.t=function(n,i){var r,u;if((i&1&&(n=t(n)),i&8)||i&4&&typeof n=="object"&&n&&n.__esModule)return n;if(r=Object.create(null),t.r(r),Object.defineProperty(r,"default",{enumerable:!0,value:n}),i&2&&typeof n!="string")for(u in n)t.d(r,u,function(t){return n[t]}.bind(null,u));return r},t.n=function(n){var i=n&&n.__esModule?function(){return n["default"]}:function(){return n};return t.d(i,"a",i),i},t.o=function(n,t){return Object.prototype.hasOwnProperty.call(n,t)},t.p="",t(t.s=0)}([function(n,t,i){"use strict";i.r(t);var u=i(1),f=i.n(u),r=i(3);i.d(t,"AbortError",function(){return r.AbortError});i.d(t,"HttpError",function(){return r.HttpError});i.d(t,"TimeoutError",function(){return r.TimeoutError});i.d(t,"HttpClient",function(){return r.HttpClient});i.d(t,"HttpResponse",function(){return r.HttpResponse});i.d(t,"DefaultHttpClient",function(){return r.DefaultHttpClient});i.d(t,"HubConnection",function(){return r.HubConnection});i.d(t,"HubConnectionState",function(){return r.HubConnectionState});i.d(t,"HubConnectionBuilder",function(){return r.HubConnectionBuilder});i.d(t,"MessageType",function(){return r.MessageType});i.d(t,"LogLevel",function(){return r.LogLevel});i.d(t,"HttpTransportType",function(){return r.HttpTransportType});i.d(t,"TransferFormat",function(){return r.TransferFormat});i.d(t,"NullLogger",function(){return r.NullLogger});i.d(t,"JsonHubProtocol",function(){return r.JsonHubProtocol});i.d(t,"Subject",function(){return r.Subject});i.d(t,"VERSION",function(){return r.VERSION});Uint8Array.prototype.indexOf||Object.defineProperty(Uint8Array.prototype,"indexOf",{value:Array.prototype.indexOf,writable:!0});Uint8Array.prototype.slice||Object.defineProperty(Uint8Array.prototype,"slice",{value:function(n,t){return new Uint8Array(Array.prototype.slice.call(this,n,t))},writable:!0});Uint8Array.prototype.forEach||Object.defineProperty(Uint8Array.prototype,"forEach",{value:Array.prototype.forEach,writable:!0})},function(n,t,i){(function(t){var r;
/*!
