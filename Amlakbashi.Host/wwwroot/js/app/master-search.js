...
function search_catrgories(e) {
    ...
    if (isNaN(search_string) === false) {
        let searchContent = '<div onclick="searchByAdvertiseId(' + search_string + ')" style="color:#242424;font:13px Miransans;padding:5px 10px;display: flex;align-items: center;"><i class="fa fa-search"></i><span>کد آگهی ' + search_string + '</span></div>';
    ...
    var url = "/app/Category/search?phrase="
        + search_string +
