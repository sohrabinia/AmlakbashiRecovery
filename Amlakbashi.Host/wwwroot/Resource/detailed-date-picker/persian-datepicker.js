/*
** persian-Dtdatepicker - v1.1.3
** Reza Babakhani <babakhani.reza@gmail.com>
** http://babakhani.github.io/PersianWebToolkit/docs/Dtdatepicker
** Under WTFPL license 
*/ 
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["persiandatepickerDt"] = factory();
	else
		root["persiandatepickerDt"] = factory();
})(this, function() {
...
var Helper = {
    ...
    /**
     * @desc show debug messages if window.persiandatepickerDtDebug set as true
     * @param elem
     * @param input
     * @example window.persiandatepickerDtDebug = true;
     * debug('element','message');
     */
    debug: function debug(elem, input) {
        /*eslint-disable no-console */
        if (window.persiandatepickerDtDebug) {
    ...
    delay: function delay(callback, ms) {
        clearTimeout(window.DtdatepickerTimer);
        window.DtdatepickerTimer = setTimeout(callback, ms);
    }
};
...
/**
 * Main Dtdatepicker object, manage every things
 */
...
var Model = function () {
  ...
  _createClass(Model, [{
    ...
    value: function components(inputElement, options) {
      ...
      /**
       * @desc render Dtdatepicker view base on State
       * @type {View}
       */
...
/**
 * This is the API documentation for persian-Dtdatepicker
 */
var API = function () {
    function API(model) {
     ...
     * @example var pd = $('.selector').persiandatepickerDt();
    ...
    _createClass(API, [{
        ...
        /**
         * @description make Dtdatepicker visible
         * @example var pd = $('.selector').persiandatepickerDt();
         * pd.show();
         */
        value: function show() {
        ...
        /**
         * @description return Dtdatepicker current state
         * @since 1.0.0
         * @example var pd = $('.selector').persiandatepickerDt();
        ...
        /**
         * @description make Dtdatepicker invisible
         * @example var pd = $('.selector').persiandatepickerDt();
         * pd.show();
         */
        ...
        /**
         * @description toggle Dtdatepicker visibility state
         * @example var pd = $('.selector').persiandatepickerDt();
         * pd.toggle();
         */
        ...
        /**
         * @description set selected date of Dtdatepicker accept unix timestamp
         * @param unix
         * @example var pd = $('.selector').persiandatepickerDt();
         ...
         * pd.options = {};
         * // set options and render Dtdatepicker with new options
         */
        ,
...
/**
 * @description persian-Dtdatepicker configuration document
 */
var Config = {

  /**
   * @description set default calendar mode of Dtdatepicker, available options: 'persian', 'gregorian'
   * @default 'persian'
   * @type string
   * @since 1.0.0
   */
  ...
  /**
   * @description if true Dtdatepicker render inline
   * @type boolean
   * @default false
   */
  'inline': false,
  ...
  /**
   * @description If set true Dtdatepicker init with input value date, use data-date property when you want set inline Dtdatepicker initial value
   * @type boolean
   * @default true
   */
  'initialValue': true,
  ...
  /**
   * @description An input element that is to be updated with the selected date from the Dtdatepicker. Use the altFormat option to change the format of the date within this field. Leave as blank for no alternate field. acceptable value: : '#elementId','.element-class'
   * @type {boolean}
   * @default false
   * @example
  ...
  /**
   * @description Set min date on Dtdatepicker, prevent user select date before given unix time
   * @property minDate
   * @type Date
   * @default null
   */
  ...
  /**
   * @description Set max date on Dtdatepicker, prevent user select date after given unix time
   * @property maxDate
   * @type Date
   * @default null
   */
  ...
  'navigator': {
     ...
     *  }
     */
    'onNext': function onNext(DtdatepickerObject) {
      Helper.debug(DtdatepickerObject, 'Event: onNext');
    },
     ...
     *  }
     */
    'onPrev': function onPrev(DtdatepickerObject) {
      Helper.debug(DtdatepickerObject, 'Event: onPrev');
    },

    /**
     * @description Called when navigator switch
     * @event
     * @example function (DtdatepickerObject) {
            // console.log('navigator switch ');
     *  }
     */
    'onSwitch': function onSwitch(DtdatepickerObject) {
      Helper.debug(DtdatepickerObject, 'dayPicker Event: onSwitch');
    }
  },
  ...
  'toolbox': {
    ...
    submitButton: {
       ...
       * @event
       */
      onSubmit: function onSubmit(DtdatepickerObject) {
        Helper.debug(DtdatepickerObject, 'dayPicker Event: onSubmit');
      }
    },
    ...
    todayButton: {
       ...
       * @event
       */
      onToday: function onToday(DtdatepickerObject) {
        Helper.debug(DtdatepickerObject, 'dayPicker Event: onToday');
      }
    },
  ...
  'timePicker': {
    ...
    'meridian': {
      ...
      /**
       * @description if you set this as false, Dtdatepicker timepicker system moved to 24-hour system
       * @type boolean
       */
      'enabled': false
    }
  ...
  'onSelect': function onSelect(unixDate) {
    Helper.debug(this, 'Dtdatepicker Event: onSelect : ' + unixDate);
  },
  ...
  'onSet': function onSet(unixDate) {
    Helper.debug(this, 'Dtdatepicker Event: onSet : ' + unixDate);
  },

  /**
   * @description position of Dtdatepicker relative to input element
   * @type string | array
   * @default 'auto'
   * @example
   *  'position': 'auto'
  ...
  /**
   * @description A function that takes current Dtdatepicker instance. It is called just before the Dtdatepicker is displayed.
   * @event
   */
  'onShow': function onShow(DtdatepickerObject) {
    Helper.debug(DtdatepickerObject, 'Event: onShow ');
  },

  /**
   * @description A function that takes current Dtdatepicker instance. It is called just before the Dtdatepicker Hide.
   * @event
   */
  'onHide': function onHide(DtdatepickerObject) {
    Helper.debug(DtdatepickerObject, 'Event: onHide ');
  },

  /**
   * @description on toggle Dtdatepicker event
   * @event
   */
  'onToggle': function onToggle(DtdatepickerObject) {
    Helper.debug(DtdatepickerObject, 'Event: onToggle ');
  },

  /**
   * @description on destroy Dtdatepicker event
   * @event
   */
  'onDestroy': function onDestroy(DtdatepickerObject) {
    Helper.debug(DtdatepickerObject, 'Event: onDestroy ');
  },

  /**
   * @description If true Dtdatepicker close When select a date
   * @type {boolean}
   * @default false
   */
  'autoClose': true,
  ...
  /**
   * @description by default Dtdatepicker have a template string, and you can overwrite it simply by replace string in config.
   * @type string
   * @example
   * <div id="plotId" class="Dtdatepicker-plot-area Dtdatepicker-plot-area-inline-view">
   {{#navigator.enabled}}
   <div class="navigator">
   <div class="Dtdatepicker-header">
  ...
  /**
   * @description if true Dtdatepicker update self by user inputted date string, accept 'yyyy/mm/dd'
   * @example '1396/10/2', ''
   * @type {boolean}
   * @default false
   */
...
(function ($) {
    ...
    $.fn.persiandatepickerDt = $.fn.pDtdatepicker = function (options) {
        ...
        $(this).each(function () {
            ...
            var emptyArr = [],
                ...
                dp = $(this).data('Dtdatepicker'),
                funcName = null;
            if (dp && typeof tempArg[0] === 'string') {
                funcName = tempArg[0];
                output = dp[funcName](tempArg[0]);
            } else {
                self.pDtdatepicker = new Model(this, options);
            }
        });
        $(this).data('Dtdatepicker', self.pDtdatepicker);
        return self.pDtdatepicker;
    };
...
var Input = function () {
    ...
    _createClass(Input, [{
        ...
        value: function addInitialClass() {
            $(this.elem).addClass('pwt-Dtdatepicker-input-element');
        }
    }, {
        key: 'parseInput',
        ...
        value: function getOnInitState() {
            var persiandatepickerDtTimeRegex = '^([0-1][0-9]|2[0-3]):([0-5][0-9])(?::([0-5][0-9]))?$';
            ...
            if (inputValue && inputValue.match(persiandatepickerDtTimeRegex)) {
    ...
    _createClass(Navigator, [{
        ...
        value: function liveAttach() {
            ...
            if (this.model.options.navigator.scroll.enabled) {
                var that = this;
                var gridPlot = $('#' + that.model.view.id + ' .Dtdatepicker-grid-view')[0];
        ...
        value: function _attachEvents() {
            ...
            if (this.model.options.dayPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .Dtdatepicker-day-view td:not(.occupied)', function () {
            ...
            if (this.model.options.monthPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .Dtdatepicker-month-view .month-item:not(.month-item-disable)', function () {
            ...
            if (this.model.options.yearPicker.enabled) {
                 ...
                 */
                $(document).on('click', '#' + that.model.view.id + ' .Dtdatepicker-year-view .year-item:not(.year-item-disable)', function () {
            ...
            if (nav == 'next') {
                ...
                if (this.viewMode == 'day') {
                    ...
                    if (this.view.month == 11) {
                        this.setViewDateTime('month', 11.95);
                    }
                    else if (this.view.month + 1 == 13) {
...
var Toolbox = function () {
    ...
    /**
     * @param {Dtdatepicker} Dtdatepicker
     * @return {Toolbox}
     */
...
var View = function () {
    ...
    function View(model) {
        ...
        if (this.model.state.ui.isInline) {
            this.$container = $('<div  id="' + this.id + '" class="Dtdatepicker-container-inline"></div>').appendTo(that.model.inputElement);
        } else {
            this.$container = $('<div  id="' + this.id + '" class="Dtdatepicker-container"></div>').appendTo('body');
            this.hide();
    ...
    _createClass(View, [{
        ...
        /**
         * @desc remove Dtdatepicker container element from dom
         */
        ...
        /**
         * @desc set Dtdatepicker container element based on <input/> element position
         */
        ...
        /**
         * @desc show Dtdatepicker container element
         */
        ...
        /**
         * @desc hide Dtdatepicker container element
         */
        ...
        /**
         * @desc toggle Dtdatepicker container element
         */
        ...
        /**
         * @private
         * @return {{enabled: boolean, hour: {title, enabled: boolean}, minute: {title, enabled: boolean}, second: {title, enabled: boolean}, meridian: {title: (meridian|{title, enabled}|ClassDtdatepicker.ClassConfig.timePicker.meridian|{enabled}|string|string), enabled: boolean}}}
         */
        ...
        value: function getCssClass() {
            return [this.model.state.ui.isInline ? 'Dtdatepicker-plot-area-inline-view' : '', !this.model.options.timePicker.meridian.enabled ? 'Dtdatepicker-state-no-meridian' : '', this.model.options.onlyTimePicker ? 'Dtdatepicker-state-only-time' : '', !this.model.options.timePicker.second.enabled ? 'Dtdatepicker-state-no-second' : '', this.model.options.calendar_ == 'gregorian' ? 'Dtdatepicker-gregorian' : 'Dtdatepicker-persian'].join(' ');
        }
        ...
        /**
         * @render Dtdatepicker view element
         * @param data
         */
