        ...
        value: function _attachEvents() {
            ...
            if (this.model.options.dayPicker.enabled) {
                ...
                if (allowSelectDisabled) {
                    selector_string = '#' + that.model.view.id + ' .datepicker-day-view td';
                }
                else {
                    selector_string = '#' + that.model.view.id + ' .datepicker-day-view td:not(.occupied)';
                }
                $(document).on('click',selector_string, function () {
