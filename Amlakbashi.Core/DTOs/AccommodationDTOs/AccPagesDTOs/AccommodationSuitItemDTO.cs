...
{
    public class AccommodationSuitItemDTO
    {
        public AccommodationSuitItemDTO(AdvertiseMode advertiseMode)
        {
        ...
        public static implicit operator AccommodationSuitItemDTO(AdvertiseDirector director)
        {
            var dto = new AccommodationSuitItemDTO(director.Mode);
