...
{
    public class AccommodationVillaItemDTO
    {
        public AccommodationVillaItemDTO(AdvertiseMode advertiseMode)
        {
        ...
        public static implicit operator AccommodationVillaItemDTO(AdvertiseDirector director)
        {
            var dto = new AccommodationVillaItemDTO(director.Mode);
            ...
            PropertyCopier<LandAreaPart, LandAreaDTO>.Copy(director.GetAdvertisePart<LandAreaPart>(), dto.LandArea);
