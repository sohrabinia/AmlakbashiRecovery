...
{
    public class AccommodationHouseItemDTO
    {
        public AccommodationHouseItemDTO(AdvertiseMode advertiseMode)
        {
        ...
        public static implicit operator AccommodationHouseItemDTO(AdvertiseDirector director)
        {
            var dto = new AccommodationHouseItemDTO(director.Mode);
