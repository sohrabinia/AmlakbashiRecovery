...
{
    public class AccommodationApartmentItemDTO
    {
        public AccommodationApartmentItemDTO(AdvertiseMode advertiseMode)
        {
        ...
        public static implicit operator AccommodationApartmentItemDTO(AdvertiseDirector director)
        {
            var dto = new AccommodationApartmentItemDTO(director.Mode);
