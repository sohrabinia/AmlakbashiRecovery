    ...
    public class AdvertiseBasicInfoReponse
    {
        ...
        public static implicit operator AdvertiseBasicInfoReponse(Advertise advertise)
        {
            return new AdvertiseBasicInfoReponse()
            {
                ...
                statusTitle = AdvertiseMainLocalization.GetAdvertiseStatusPersianName((int)advertise.Status, true),
                createDate = DateTimeUtility.GregorianToPersianDateWithSlash(advertise.CreateDate),
                title = advertise.Title,
                type = AdvertiseMainLocalization.GetAdvertiseTypePersianNameForUser(advertise.TypeID),
